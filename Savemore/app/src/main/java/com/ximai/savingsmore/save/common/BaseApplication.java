    ...
    private void setChatoptions() {
        ...
        EaseUI.getInstance().setSettingsProvider(new EaseUI.EaseSettingsProvider() {
            ...
            public boolean isMsgNotifyAllowed(EMMessage message) {
                return PreferencesUtils.getBoolean(getApplicationContext(), IS_MSG_NOTIFY_ALLOWED, true);
            }

            @Override
            public boolean isMsgSoundAllowed(EMMessage message) {
                return PreferencesUtils.getBoolean(getApplicationContext(), IS_MSG_SOUND_ALLOWED, true);
            }

            @Override
            public boolean isMsgVibrateAllowed(EMMessage message) {
                return PreferencesUtils.getBoolean(getApplicationContext(), IS_MSG_VIBRATE_ALLOWED, true);
            }
